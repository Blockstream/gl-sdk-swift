Pod::Spec.new do |spec|
    spec.name                   = "glsdkFFI"
    spec.version                = "202511-gl-sdk-swift"
    ...
    spec.source                 = { :http => "https://github.com/Blockstream/gl-sdk-swift/releases/download/202511-gl-sdk-swift/glsdkFFI.xcframework.zip" }
